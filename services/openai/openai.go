...
func promptWithoutCode(file, identifier, longIdentifier string) string {
	return fmt.Sprintf(
		"Write a concise documentation for %q in GoDoc format. Use brackets to enclose symbol references. Start the first sentence with %q. Write in the style of Go library documentation. Do not add any links. Do not output the source code code or code examples. This is the source code of the file:\n\n%s",
		longIdentifier,
